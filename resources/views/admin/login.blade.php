        ...
        <div class="card-body">
            <form action="{{route('admin_logincheck')}}" method="post">
                ...
                <div class="form-group">
                    <input class="form-control form-control-lg" id="username" type="email" placeholder="Username or email" autocomplete="off">
                </div>
                <div class="form-group">
                ...
                <input value="Sign in" type="submit" class="btn btn-primary btn-lg btn-block">
            </form>
        </div>
