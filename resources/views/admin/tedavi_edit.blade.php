        ...
        <div class="container-fluid dashboard-content">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <h3 class="text-center">Editing Tedavi</h3>
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="basicform">Edit tedavi</div>
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{route('admin_tedavi_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                        @csrf
